# 🚀 Jóvenes en Órbita - Cerca de JEO

**Desarrollado por:** Macarena Nicole Chanampa  
...
| :--- | :--- | :--- |
| **Lunes 01/09** | **Diseño & Fundamentos** | Definición conceptual del sitio, selección de la identidad visual (paleta de colores, fuentes) y elección del toolkit inicial. |
| **Martes 02/09** | **Arquitectura** | Configuración del entorno de trabajo local y definición de la arquitectura técnica (*stack*). |
| **Miércoles 03/09 - Jueves 04/09** | **Implementación** | Maquetación y desarrollo del código frontend. Uso de Inteligencia Artificial como copiloto para la optimización de lógica, estilos CSS y resolución de desbordamientos (*overflow*). |
...
3. **Experiencia de Usuario (UX):** Diseñé transiciones e interacciones donde cada sección se siente distinta, utilizando contrastes de luz y composiciones únicas para representar la diversidad de JEO.
...
* **Backend:** Node.js
* **Asistencia IA (Copilotos):** Gemini, Claude, Stitch, Canva AI, DeepSeek
...
* [Josh W. Comeau](https://www.joshwcomeau.com/) — Guías avanzadas de CSS y Layouts.
...
1. Clona el repositorio:
   ```bash
   git clone [https://github.com/tu-usuario/jovenes-en-orbita.git](https://github.com/tu-usuario/jovenes-en-orbita.git)

## O visita la pagina web a través del siguiente link: 
[about to jeo](https://abouttojeo-page.vercel.app)
